...
import { deleteTherapist } from "@/lib/actions/therapists";
import { useRouter } from "@/i18n/routing";
import BaseModal from "@/components/common/BaseModal";
import { Button } from "@/components/common/Button";

export default function DeleteTherapistButton({ id }: { id: string }) {
        ...
        <BaseModal.Body>
          <div className="space-y-4">
            ...
            <p className="text-sm text-custom-blue/60 dark:text-custom-celadon/60 leading-relaxed">
              This action cannot be undone. All data associated with this professional will be permanently removed from our system.
            </p>
          </div>
        </BaseModal.Body>
